...
<YoutubeEmbed embedUrl="https://www.youtube.com/embed/LEethjxNnrw?si=LPGQLn3C2x9hgmPm" />
...
<GithubCard owner='chickensoft-games' repo='GameDemo' logo='/img/chickensoft/game_demo.png'/>
...
<FancyImage src={"/blogs/game-architecture/white_whale.png"} alt="Architecture: software engineering's white whale.">
...
<FancyImage src={"/blogs/game-architecture/architecture_sanity.png"} alt="Architecture sanity test.">
...
<FancyImage src={"/blogs/game-architecture/game_architecture.png"} alt="Game Architecture Layers of Abstraction">
...
<FancyImage src={"/blogs/game-architecture/visual_component.png"} alt="Game Engine Visual Components">
...
<FancyImage src={"/blogs/game-architecture/game_engine.png"} alt="Level being edited in the Godot game engine.">
...
<FancyImage src={"/blogs/game-architecture/visual_game_logic.png"} alt="Game Engine Visual Components">
You know, the part you can actually see.
</FancyImage>
...
<FancyImage src={"/blogs/game-architecture/player.png"} alt="Player state diagram generated by LogicBlocks.">
...
<FancyImage src={"/blogs/game-architecture/chess.png"} alt="Capturing in Chess">
...
<FancyImage src={"/blogs/game-architecture/separating_game_logic.png"} alt="Separating game logic from visualization.">
...
<FancyImage src={"/blogs/game-architecture/tree_based_dependencies.png"} alt="Tree-based dependency provisioning">
...
<FancyImage src={"/blogs/game-architecture/not_so_layered_architecture.png"} alt="Not-so-layered architecture">
...
<FancyImage src={"/blogs/game-architecture/scene_explosion.png"} alt="The scene explosion problem.">
...
<FancyImage src={"/blogs/game-architecture/unit_tests.png"} alt="Why that one teammate won't shut up about unit tests">
...
<FancyImage src={"/blogs/game-architecture/testing_abstractions.png"} alt="Layers of Abstraction in Testing">
