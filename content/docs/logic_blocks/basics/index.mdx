---
title: 🧮 Basics
description: Learn the basics of LogicBlocks and how they work.
image: /docs/logic_blocks/header.jpg
---

<FancyImage src="/docs/logic_blocks/basics/logic_block.png" alt="Logic block visual diagram" />
...
A **state** is an object with "lifecycle hooks" that allow it to observe when it has been entered or exited. Only one state instance is ever active at once. The active state is available via the logic block's `State` property.
