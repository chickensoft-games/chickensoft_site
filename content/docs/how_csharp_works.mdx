...
description: Understanding game development with Godot and C#.
---
...
<FancyImage src="/docs/how_csharp_works/add_script.png" alt="Adding a C# script to a project." widthOverride="576px" />
...
<FancyImage src="/docs/how_csharp_works/build_button.png" alt=".NET project build button inside Godot" />
